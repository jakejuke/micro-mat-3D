function [phi, n, dU, dr, dG] = calcmisor2(a,b,varargin)
%calcmisor2 Calculate the misorientation between two grains/objects
%(applies symmetry matrices (Gs) twice) -- but always(?) gives the same
%result as calcmisor, which only applies G once.
%
%
...
%
%   REFERENCES:
%       PhD thesis from Srikanth Patala from MIT
%       Also Engler's book from 2010 (but this is not so good)
%   
%   
